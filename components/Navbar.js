        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link href="/" className="flex items-center">
              <span className="text-2xl font-bold text-primary">Elder</span>
              <span className="text-2xl font-bold text-secondary">Care</span>
            </Link>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-t">
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <Link href="/services" className="block px-3 py-2 text-gray-700 hover:bg-gray-100 rounded">Services</Link>

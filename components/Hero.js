      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            {/* Main Phone Mockup */}
            <div className="relative mx-auto w-full max-w-[300px] aspect-[9/19] rounded-[3rem] border-[12px] border-gray-900 bg-gray-900 shadow-2xl overflow-hidden z-10">
              <Image 
                src="/screenshots/elder_home.png" 
